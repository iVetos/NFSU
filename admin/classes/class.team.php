...
class Team
{
     ...
     * @return boolean
     */
    public static function add($table, $name, $post, $text_s, $text, $img, $title, $description, $keywords)
    {
     ...
     * @return boolean
     */
    public static function edit($id, $table, $name, $post, $text_s, $text, $img, $title, $description, $keywords)
    {
